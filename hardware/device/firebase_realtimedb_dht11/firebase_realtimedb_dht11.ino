...
void sensorUpdate(){
  ...
  if (Firebase.setFloat(firebaseData, "/product-design-group-15-default-rtdb/temperature", t))
  {
  ...
  if (Firebase.setFloat(firebaseData, "/product-design-group-15-default-rtdb/humidity", h))
  {
    Serial.println("PASSED");
    Serial.println("PATH: " + firebaseData.dataPath());
    Serial.println("TYPE: " + firebaseData.dataType());
...
void loop() {
  ...
  if (Firebase.getString(ledData, "/product-design-group-15-default-rtdb/led")){
